...
class CategoryController extends Controller
{
    ...
    public function insert(Request $request){
        ...
        return redirect('/admin/category/list')->with('success', 'New Category Is Added Successfully.');
    }
    ...
    public function update($id, Request $request){
        ...
        return redirect('/admin/category/list')->with('success', 'Category Is Updated Successfully.');
    }
