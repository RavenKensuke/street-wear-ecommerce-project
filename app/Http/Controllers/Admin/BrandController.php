...
class BrandController extends Controller
{
    ...
    public function insert(Request $request){
        ...
        return redirect('/admin/brand/list')->with('success', 'New Brand Is Added Successfully.');
    }
    ...
    public function update($id, Request $request){
        ...
        return redirect('/admin/category/list')->with('success', 'Brand Is Updated Successfully.');
    }
